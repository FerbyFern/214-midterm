...
**6. Which book has the longest title?**

```R
BooksPrice <- as.factor(Books$Price)
summary(BooksPrice)
```
...
```
  ...
  9.324  30.751  46.318  54.542  67.854 235.650 
```
Explain

- as.factor : Convert the data.
- summary : Result summaries of the results of various.
